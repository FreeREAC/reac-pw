...
EDGE[4 /* REAC_M_IDLE..REAC_M_ESTABLISHED */][REAC_M_EV_COUNT] = {
	...
	[REAC_M_IDLE] = {
		...
		[REAC_M_EV_BOX_UNKNOWN]     = HOLD(REAC_M_IDLE),
	},
	...
	[REAC_M_PROBING] = {
		...
		[REAC_M_EV_BOX_UNKNOWN]     = HOLD(REAC_M_PROBING),
	},
	...
	[REAC_M_GRANTING] = {
		...
		[REAC_M_EV_BOX_UNKNOWN]     = GO(REAC_M_PROBING, REAC_M_DROP_BOX_UNKNOWN, 1),
	},
	...
	[REAC_M_ESTABLISHED] = {
		...
		[REAC_M_EV_BOX_UNKNOWN]     = HOLD(REAC_M_ESTABLISHED),
	},
};
